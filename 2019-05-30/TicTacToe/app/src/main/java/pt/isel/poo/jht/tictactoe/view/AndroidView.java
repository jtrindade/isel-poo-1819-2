...
public class AndroidView extends TView {
    ...
    public AndroidView(Activity activity) {
        ...
        count = activity.findViewById(R.id.fldCount);
    ...
    @Override
    public void showCount(int value) { count.setValue(value); }
    ...
    @Override
    public void setCellValue(int c, int r, CellValue cellValue) {
        super.setCellValue(c, r, cellValue);
        if (cellValue != CellValue.EMPTY) {
            showNewPlay(cellValue, c, r);
        }
    }
}
